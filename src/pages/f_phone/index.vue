<template>
  <view class="container">
      <view class="inp">
            <input id="inp" placeholder="请输入手机号" focus="{{focusFlag}}" type="idcard" @input="bindblur" value="{{inputTxt}}" maxlength="11"/>
            <view class="clear">
...
export default {
    ...
    onLoad(e){
        if(e.phoneNum && e.phoneNum != "null"){
            this.inputTxt = e.phoneNum
            this.focusFlag = 1
            this.isInput = 1
        }else{
            this.focusFlag = 1
