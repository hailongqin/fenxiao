<template>
  <view class="container">
      <view class="inp">
            <input id="inp" placeholder="请输入昵称" focus="{{focusFlag}}" type="text" @input="bindblur" value="{{inputTxt}}" maxlength="20"/>
            <view class="clear">
...
.container .cancel{
    ...
    width:670rpx;
    border-radius: 10rpx;
    border:1rxp solid rgba(5,5,5,0.1);
    font-size:36rpx;
    text-align: center;
    color:#000;
    margin:30rpx auto;
